                ...
                <div class="card-body">
                    <div class="mb-3 d-flex justify-content-center">
                        <div style="width:88px;height:88px;border-radius:50%;overflow:hidden;border:1px solid #ddd;">
                            <img src="{{ asset('images/profile/raidin_profile.jpeg') }}" alt="Foto Pesero Komanditer" style="width:100%;height:100%;object-fit:cover;object-position:center 30%;transform:scale(1.12);">
                        </div>
                    </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm card-hover text-center">
                <div class="card-body">
                    <div class="mb-3 d-flex justify-content-center">
                        <div style="width:88px;height:88px;border-radius:50%;overflow:hidden;border:1px solid #ddd;">
                            <img src="{{ asset('images/profile/eko_profile.jpeg') }}" alt="Foto Manajer/Administrasi" style="width:100%;height:100%;object-fit:cover;object-position:center 30%;transform:scale(1.12);">
                        </div>
                    </div>
