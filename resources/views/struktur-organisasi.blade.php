    ...
    <div class="row g-3">
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm card-hover text-center">
                <div class="card-body">
                    <div class="mb-3 d-flex justify-content-center">
                        <div style="position:relative;width:88px;height:88px;border-radius:50%;overflow:hidden;">
                            <div style="position:absolute;top:6px;left:10px;width:64px;height:64px;border-radius:50%;overflow:hidden;border:1px solid #ddd;box-shadow:0 2px 6px rgba(0,0,0,0.15);">
                                <img src="{{ asset('images/profile/heriady_profile.jpeg') }}" alt="Heriady, ST" style="width:100%;height:100%;object-fit:cover;object-position:center 40%;">
                            </div>
                            <div style="position:absolute;bottom:6px;right:10px;width:64px;height:64px;border-radius:50%;overflow:hidden;border:1px solid #ddd;box-shadow:0 2px 6px rgba(0,0,0,0.15);">
                                <img src="{{ asset('images/profile/raidin_profile.jpeg') }}" alt="Raidin Warmansyah" style="width:100%;height:100%;object-fit:cover;object-position:center 45%;">
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center mb-3">
                        <img src="{{ asset('images/profile/heriady_profile.jpeg') }}" alt="Heriady, ST" class="avatar-lg">
                    </div>
    ...
    <div class="modal fade" id="modalPesero" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center mb-3">
                        <img src="{{ asset('images/profile/raidin_profile.jpeg') }}" alt="Raidin Warmansyah" class="avatar-lg">
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex flex-wrap gap-3 mb-2">
                        <div class="text-center">
                            <img src="{{ asset('images/profile/heriady_profile.jpeg') }}" alt="Heriady, ST" class="avatar-lg mb-1">
                            <div class="small fw-semibold">Heriady, ST</div>
                        </div>
                        <div class="text-center">
                            <img src="{{ asset('images/profile/raidin_profile.jpeg') }}" alt="Raidin Warmansyah" class="avatar-lg mb-1">
                            <div class="small fw-semibold">Raidin Warmansyah</div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modalManajer" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center mb-3">
                        <img src="{{ asset('images/profile/eko_profile.jpeg') }}" alt="Eko Widigdo, SE" class="avatar-lg">
                    </div>
